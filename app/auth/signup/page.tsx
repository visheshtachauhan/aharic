        ...
        <div className="max-w-md w-full space-y-8 p-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Registration is disabled in demo mode. All owner routes are accessible without signup.
            </p>
            <div className="mt-4">
              <a 
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Registration system coming soon...</p>
      </div>
    </div>
  );
}